...
final class ChannelUITests: XCTestCase {
    ...
    func testChannelSuccessful() throws {
        ...
        app/*@START_MENU_TOKEN@*/.staticTexts["Desconectado"]/*[[".otherElements.staticTexts[\"Desconectado\"]",".staticTexts.firstMatch",".staticTexts[\"Desconectado\"]"],[[[-1,2],[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
